...
public class DataHolder implements DataHolderService {
	...
	@Override
	public Map<Long, Double> overDraftDataHolder() {
		Map<Long, Double> current = new HashMap<>();

		current.put(201L, 100000.0);
		current.put(203L, 100000.0);
		current.put(204L, 100000.0);
		current.put(205L, 100000.0);
		current.put(206L, 100000.0);
